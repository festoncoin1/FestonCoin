...
In order to support loading of multiple wallets in feston-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is feston.cpp.
...
Changes to feston.cpp
----------------------
feston.cpp is the entry point into feston-qt, and as such, will require some minor modifications to provide hooks for
