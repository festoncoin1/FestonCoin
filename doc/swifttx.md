...
* WebSocket: [https://github.com/FestonCoin-Core/insight-api-feston#web-socket-api](https://github.com/FestonCoin-Core/insight-api-feston#web-socket-api)
* API: [https://github.com/FestonCoin-Core/insight-api-feston#swifttx-transactions](https://github.com/FestonCoin-Core/insight-api-feston#swifttx-transactions)
...
By default, the FestonCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FestonCoin Core daemon:
