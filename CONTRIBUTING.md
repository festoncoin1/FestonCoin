Contributing to FestonCoin Core
============================

The FestonCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FestonCoin Core project, and is not to be
confused with overall FestonCoin Network Protocol consensus changes.

Whether a pull request is merged into FestonCoin Core rests with the project merge
...
Patches that change FestonCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the FestonCoin consensus, it must have been
...
The project leader is the release manager for each FestonCoin Core release.
