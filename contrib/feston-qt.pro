...
RESOURCES += src/qt/feston.qrc src/qt/feston_locale.qrc

TRANSLATIONS += src/qt/locale/feston_bg.ts \
                src/qt/locale/feston_de.ts \
                src/qt/locale/feston_en.ts \
                src/qt/locale/feston_es.ts \
                src/qt/locale/feston_fi.ts \
                src/qt/locale/feston_fr.ts \
                src/qt/locale/feston_it.ts \
                src/qt/locale/feston_ja.ts \
                src/qt/locale/feston_pl.ts \
                src/qt/locale/feston_pt.ts \
                src/qt/locale/feston_ru.ts \
                src/qt/locale/feston_sk.ts \
                src/qt/locale/feston_sv.ts \
                src/qt/locale/feston_vi.ts \
                src/qt/locale/feston_zh_CN.ts \
                src/qt/locale/feston_zh_TW.ts
