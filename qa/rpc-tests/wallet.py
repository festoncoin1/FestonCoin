...
#   c) node1 mines 32 blocks, so now node 0 has 60001feston, node 1 has 4250feston, node2 has none.
#   d) node0 sends 601 feston to node2, in two transactions (301 feston, then 300 feston).
