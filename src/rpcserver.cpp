...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop FestonCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "FestonCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FestonCoin features */
        {"feston", "masternode", &masternode, true, true, false},
        {"feston", "listmasternodes", &listmasternodes, true, true, false},
        {"feston", "getmasternodecount", &getmasternodecount, true, true, false},
        {"feston", "masternodeconnect", &masternodeconnect, true, true, false},
        {"feston", "masternodecurrent", &masternodecurrent, true, true, false},
        {"feston", "masternodedebug", &masternodedebug, true, true, false},
        {"feston", "startmasternode", &startmasternode, true, true, false},
        {"feston", "createmasternodekey", &createmasternodekey, true, true, false},
        {"feston", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"feston", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"feston", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"feston", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"feston", "getmasternodescores", &getmasternodescores, true, true, false},
        {"feston", "mnsync", &mnsync, true, true, false},
        {"feston", "spork", &spork, true, true, false},
        {"feston", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"feston", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use festond, or the -server option to feston-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> feston-cli " + methodname + " " + args + "\n";
}
