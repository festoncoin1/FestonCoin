...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FestonCoin Core feston-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  feston-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded FestonCoin transaction") + "\n" +
                               "  feston-tx [options] -create [commands]   " + _("Create hex-encoded FestonCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded FestonCoin transaction
