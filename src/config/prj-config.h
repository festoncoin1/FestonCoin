/* src/config/feston-config.h.  Generated from feston-config.h.in by configure.  */
/* src/config/feston-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FestonCoin_CONFIG_H

#define FestonCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.feston.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FestonCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FestonCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "feston"
