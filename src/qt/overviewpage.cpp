...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::FTON)
    {
    }
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->label_FestonCoin4->setVisible(showImmature || showWatchOnlyImmature);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    if (model && model->getOptionsModel()) {
        ...
        connect(ui->blabel_FestonCoin, SIGNAL(clicked()), this, SLOT(openMyAddresses()));

    }

    // update the display unit, to not use the default ("FestonCoin")
    updateDisplayUnit();
}
...
void OverviewPage::updateMasternodeInfo()
{
  ...
  } else if (chainActive.Height() >= 3000 && chainActive.Height() < 20000) {
    ui->label_lcolat->setText("1000 Coins");
    ui->label_mcolat->setText("1500 Coins");
    ui->label_fcolat->setText("3000 Coins");
  } else if (chainActive.Height() >= 20000 && chainActive.Height() < 50000) {
    ui->label_lcolat->setText("1500 Coins");
    ui->label_mcolat->setText("3000 Coins");
    ui->label_fcolat->setText("5000 Coins");
  } else if (chainActive.Height() >= 50000 && chainActive.Height() < 100000) {
    ui->label_lcolat->setText("3000 Coins");
    ui->label_mcolat->setText("5000 Coins");
    ui->label_fcolat->setText("7500 Coins");
  } else if (chainActive.Height() >= 100000 && chainActive.Height() < 200000) {
    ui->label_lcolat->setText("5000 Coins");
    ui->label_mcolat->setText("7500 Coins");
    ui->label_fcolat->setText("10000 Coins");
  } else if (chainActive.Height() >= 200000 && chainActive.Height() < 350000) {
    ui->label_lcolat->setText("7500 Coins");
    ui->label_mcolat->setText("10000 Coins");
    ui->label_fcolat->setText("15000 Coins");
  } else if (chainActive.Height() >= 350000 && chainActive.Height() < 550000) {
    ui->label_lcolat->setText("10000 Coins");
    ui->label_mcolat->setText("15000 Coins");
    ui->label_fcolat->setText("20000 Coins");
  } else if (chainActive.Height() >= 550000 && chainActive.Height() < 850000) {
    ui->label_lcolat->setText("15000 Coins");
    ui->label_mcolat->setText("20000 Coins");
    ui->label_fcolat->setText("25000 Coins");
  } else if (chainActive.Height() >= 850000 && chainActive.Height() < 1500000) {
    ui->label_lcolat->setText("20000 Coins");
    ui->label_mcolat->setText("25000 Coins");
    ui->label_fcolat->setText("30000 Coins");
  } else if (chainActive.Height() >= 1500000 && chainActive.Height() < 3000000) {
    ui->label_lcolat->setText("25000 Coins");
    ui->label_mcolat->setText("30000 Coins");
    ui->label_fcolat->setText("50000 Coins");
  } else {
    ui->label_lcolat->setText("30000 Coins");
...
double BlockRewardFestonCoin =  static_cast<double>(BlockReward/COIN);
//int64_t FestonCoinSupply = chainActive.Tip()->nMoneySupply / COIN;
...
ui->label_CurrentBlockReward_value->setText(QString::number(BlockRewardFestonCoin));
//ui->label_FestonCoinSupply_value->setText(QString::number(FestonCoinSupply));
...
void OverviewPage::updateObfuscationProgress()
{
    ...
    QString strAnonymizeFTONAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeFTONAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeFTONAmount = strAnonymizeFTONAmount.remove(strAnonymizeFTONAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeFTONAmount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    ...
    if (nMaxToAnonymize > nAnonymizeFTONAmount * COIN) nMaxToAnonymize = nAnonymizeFTONAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeFTONAmount * COIN) {
        // ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
        //                                       .arg(strAnonymizeFTONAmount));
        strAnonymizeFTONAmount = strAnonymizeFTONAmount.remove(strAnonymizeFTONAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeFTONAmount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    } else {
