...
/** Utility functions used by the FestonCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render FestonCoin addresses in monospace font
...
// Parse "feston:" URI into recipient object, return true on successful parsing
