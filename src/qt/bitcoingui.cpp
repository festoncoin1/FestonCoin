...
QFontDatabase::addApplicationFont(":/fonts/feston_font");

QString windowTitle = tr("FestonCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FestonCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and FestonCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FestonCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about FestonCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FestonCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FestonCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FestonCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a FestonCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the FestonCoin Core help message to get a list with possible FestonCoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenuBar* appMenuBar = new QMenuBar(this);
#else
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FestonCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FestonCoin network", "", count));
}
...
{
    QString strTitle = tr("FestonCoin Core"); // default title
