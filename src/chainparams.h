 ...
 * FestonCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& FestonCoinDevKey() const { return vFestonCoinDevKey; }
    // const std::vector<unsigned char>& FestonCoinFundKey() const { return vFestonCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vFestonCoinDevKey;
    // std::vector<unsigned char> vFestonCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
